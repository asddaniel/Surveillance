...
<div class="min-h-screen grid place-content-center">
    <div class="bg-white max-w-5xl mx-auto shadow-xl py-12 px-10">
      <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center">
        ...
        <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Photo" class="sm:rounded-full sm:w-24 sm:h-24 object-cover h-auto">
          <div class="ml-5">
            <h1 class="text-3xl font-semibold text-gray-800 mb-1">Leo Bailey</h1>
            <p class="text-gray-700">@leo_bai <span></span>Entertainment</p>
          </div>
          </div>
        <div>
