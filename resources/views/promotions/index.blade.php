...
<section>
    ...
    <div class="flex justify-center items-center min-h-screen p-5">
      <div class="w-full max-w-7xl border border-gray-400 rounded-lg overflow-x-auto">
        ...
        <div class="py-5">
            <form method="POST" action="{{ route('promotion.store') }}" class="rounded-lg p-3 shadow-xl">
                @csrf
            ...
            <tr class="border-t border-gray-400">
              ...
              <td class="px-4 py-3 flex">
                <div class="w-full flex gap-2 items-center">
                  ...
                  <a href="{{ route('promotion.edit', $promotion->id) }}" class="-ml-0.5 bg-gray-400 border px-3 p-2 font-semibold flex items-center justify-center rounded-xl  ">
                    Edit
                  </a>
                  <a href="{{ route('promotion.delete', $promotion->id) }}" class="-ml-0.5 bg-red-500 border px-3 p-2 font-semibold flex items-center justify-center rounded-xl  ">
                    supprimer
                  </a>
                </div>
              </td>
