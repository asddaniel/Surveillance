<div style="min-height: 716px" class="absolute flex-col justify-between hidden w-64 bg-gray-800 shadow sm:relative md:h-full sm:flex">
    <div class="px-8">
        <div class="flex items-center w-full h-16 text-3xl italic dark:text-white">
                Vidéo Surveillance
        </div>
        <ul class="mt-12">
            ...
            <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="{{ route('promotion.index') }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-small"><circle cx="12" cy="12" r="6"/></svg>
            ...
            <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="{{ route("placement.index") }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-small"><circle cx="12" cy="12" r="6"/></svg>
                    <span class="ml-2 text-sm">Placements</span>
                </a>
            </li>
            <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="{{ route('student.index') }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-small"><circle cx="12" cy="12" r="6"/></svg>
                    <span class="ml-2 text-sm">Etudiants</span>
                </a>
            </li>
            <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="{{ route("surveillance.index") }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-small"><circle cx="12" cy="12" r="6"/></svg>
                    <span class="ml-2 text-sm">Surveillance</span>
                </a>
                <div class="flex items-center justify-center px-3 py-1 text-xs text-gray-300 bg-gray-600 rounded">25</div>
            </li>
             <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="{{ route("code.index") }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-small"><circle cx="12" cy="12" r="6"/></svg>
                    <span class="ml-2 text-sm">Codes</span>
                </a>
                <div class="flex items-center justify-center px-3 py-1 text-xs text-gray-300 bg-gray-600 rounded">25</div>
            </li>
    ...
    <div class="px-8">
        ...
        <ul class="mt-12">
            ...
            <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-small"><circle cx="12" cy="12" r="6"/></svg>
                    <span class="ml-2 text-sm">Promotion</span>
                </a>
                <div class="flex items-center justify-center px-3 py-1 text-xs text-gray-300 bg-gray-600 rounded">8</div>
            </li>
            <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-circle-small"><circle cx="12" cy="12" r="6"/></svg>
                    <span class="ml-2 text-sm">Placement</span>
                </a>
            </li>
            <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
            ...
            <li class="flex items-center justify-between w-full text-gray-400 cursor-pointer hover:text-gray-300">
                <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    ...
                    <span class="ml-2 text-sm">Paramètre</span>
                </a>
            </li>
        </ul>
        <div class="flex justify-center w-full mt-48 mb-4">
